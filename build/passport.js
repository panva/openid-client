...
export class Strategy {
    ...
    authorizationRequestParams(_req, _options) {
        return {};
    }
    authorizationCodeGrantParameters(_req, _options) {
        return {};
    }
    async authorizationRequest(req, options) {
        try {
            ...
            if (this._usePAR) {
                redirectTo = await client.buildAuthorizationUrlWithPAR(this._config, redirectTo.searchParams, { DPoP: this._DPoP?.(req) });
            }
    ...
    async authorizationCodeGrant(req, currentUrl, options) {
        try {
            ...
            }, this.authorizationCodeGrantParameters(req, options), { DPoP: this._DPoP?.(req) });
