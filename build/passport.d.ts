...
export declare class Strategy implements passport.Strategy {
     ...
     */
    authorizationRequestParams<TOptions extends passport.AuthenticateOptions = passport.AuthenticateOptions>(_req: express.Request, _options: TOptions): URLSearchParams | Record<string, string> | undefined;
    /**
     * Return extra parameters to be included in the authorization code grant
     * token endpoint request.
     */
    authorizationCodeGrantParameters<TOptions extends passport.AuthenticateOptions = passport.AuthenticateOptions>(_req: express.Request, _options: TOptions): URLSearchParams | Record<string, string> | undefined;
    /**
